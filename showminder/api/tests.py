...
@pytest.mark.parametrize("filename, title, season, episode", [
    ...
    # info in dirname
    ("smb:///path/to/movie/Shameless.S08E08.Franks.Northern.Southern.Express.GERMAN.DUBBED.DL.1080p.WebHD.x264-TVP/tvp-shameless-s08e08-1080p.mkv", "shameless", 8, 8),
    ("smb:///path/to/movie/Imposters.S01E01.Sie.ist.weg.German.1080p.HDTV.x264-ATAX/atax-imposters.s01e01-1080p.mkv", "imposters", 1, 1),
    ("smb:///path/to/movie/Black.Lightning.S01E06.German.Dubbed.DL.720p.WEB.x264-BiGiNT/fff.mkv", "black lightning", 1, 6),
    # special mapping
    ("smb:///path/to/movie/S.W.A.T.s05e09-720p.mkv", "swat", 5, 9),
    ("smb:///path/to/movie/S.W.A.T.S01E01.Sie.ist.weg.German.1080p.HDTV.x264-ATAX/atax-s.w.a.t-s01e01-1080p.mkv", "swat", 1, 1),
